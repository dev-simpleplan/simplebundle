...
export default function DescriptionStep({ formData, setFormData, errors, setErrors, app, productTags, productTypes, i18 }) {
  ...
  return (
    <Card>
      <BlockStack gap="500">
        ...
        <Select
          label={i18.t("describeLabel")}
          options={[
            { label: i18.t("describeLabelInner"), value: '' },
