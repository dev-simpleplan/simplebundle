...
export default function InfiniteStep2({ app, formData, onProductOptionsChange, errors, i18 }) {
    ...
    return (
        <BlockStack gap="500">
            ...
            <InlineStack gap="400" align="space-between">
                <Text variant="heading2xl" as="h2">{i18.t("bundleInfiniteHead")}</Text>

                <ButtonGroup>
                    <Button variant="primary" onClick={handleMultiProductSelection}>{i18.t("bundleInfiniteBtn1")}</Button>
                    <Button variant="primary" onClick={handleSingleProductSelection}>{i18.t("bundleInfiniteBtn2")}</Button>
                    </ButtonGroup>
                </InlineStack>
            </Card>
