...
export default function ProductSelectionStep({ formData, setFormData, errors, setErrors, app, setBundleLimits, i18 }) {
      ...
      >
        <BlockStack gap="300">
          ...
          {customOptions.length > 0 ? (
            ...
            <Text>{i18.t("customization1")}</Text>
          )}
        </BlockStack>
      </ResourceItem>
    );
      ...
      <BlockStack gap="500">
        <InlineStack align="space-between">
          <Text variant="headingLg" as="h2">
            {i18.t("selectProductsHead")}
          </Text>
          {formData.products.length > 0 && (
            <Button onClick={handleProductSelection} plain>
              {i18.t("bundleInfiniteBtn1")}
            </Button>
          )}
        </InlineStack>
        ...
        {formData.products.length > 0 ? (
          ...
          <EmptyState
            heading={i18.t("selectProductEmptyHead")}
            image="https://cdn.shopify.com/s/files/1/0262/4071/2726/files/emptystate-files.png"
            action={{
              content: i18.t("selectProductsHead"),
              onAction: handleProductSelection,
            }}
          >
            <p>{i18.t("selectProductEmptyDesc")}</p>
          </EmptyState>
        )}
      </BlockStack>
      <Modal
