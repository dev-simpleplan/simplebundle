...
export function ProductTable({ products, onDeleteProduct, fetcher, navigate, i18 }) {
      ...
      >
        ...
        <IndexTable.Cell>
          <ButtonGroup segmented>
            <Tooltip content={i18.t("editBundleTooltip")} dismissOnMouseOut>
              <Button
                size="slim"
                icon={EditIcon}
                onClick={() => {
            ...
            <Tooltip content={i18.t("deleteBundleTooltip")} dismissOnMouseOut>
              <Button
                size="slim"
                icon={DeleteIcon}
  ...
  return (
    <Card>
      ...
      <IndexTable
        ...
        headings={[
          { title: i18.t("bundleTableCol1") },
          { title: i18.t("bundleTableCol2") },
          { title: i18.t("bundleTableCol3") },
          // { title: "Status" },
          { title: i18.t("bundleTableCol4") },
          { title: i18.t("bundleTableCol5") },
          { title: i18.t("bundleTableCol6") },
        ]}
        selectable={false}
      >
        {rowMarkup}
