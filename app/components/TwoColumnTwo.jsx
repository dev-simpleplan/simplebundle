...
export default function TwoColumnLayoutTwo({ children, step, bundleLimits, i18 }) {
    ...
    <Layout>
      ...
      <Layout.Section variant="oneThird">
        <BlockStack gap="400">
          <Card>
            <BlockStack gap="400">
              <Text variant="headingLg" as="h2">{i18.t("brandHead")}</Text>
              <Text>{i18.t("brandDescription")}</Text>
            </BlockStack>
          </Card>
          {step === 2 && bundleLimits && (
            <>
              <Card>
                <BlockStack gap="400">
                  ...
                  <BlockStack gap="200">
                    {renderBundleLimitItem(i18.t("bundleLimitsProds"), bundleLimits?.products, BUNDLE_LIMITS.products)}
                    {renderBundleLimitItem(i18.t("bundleLimitsOptions"), bundleLimits?.options, BUNDLE_LIMITS.options)}
