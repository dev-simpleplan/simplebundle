...
export default function EditBundle() {
  ...
  return (
    <Page title={`${i18next.t("editBundleTooltip")}: ${formData.bundleName}`}>
      ...
      <BlockStack gap="500">
        ...
        <Card sectioned>
          <FormLayout>
            <TextField
              label={i18next.t("createBundleLabel1")}
        ...
        <Card>
          ...
          <InlineStack gap="400" align="space-between">
            ...
            <ButtonGroup>
              <Button variant="primary" onClick={handleMultiProductSelection}>{i18next.t("bundleInfiniteBtn1")}</Button>
              <Button variant="primary" onClick={handleSingleProductSelection}>{i18next.t("bundleInfiniteBtn2")}</Button>
              </ButtonGroup>
            </InlineStack>
          </BlockStack>
        </Card>
